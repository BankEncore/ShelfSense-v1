...
**Companion to:** ShelfSense Register Workspace Consolidation project brief  
**Status:** Proposed  
...
**Authority:** These wireframes do not supersede Phase 6.7. Composition-MVP shortcut legends follow 6.7 except F10 (Transactions → Register Menu). A mode-scoped SALE/TENDER map appears only as a labeled target concept and is not implementation authority.
