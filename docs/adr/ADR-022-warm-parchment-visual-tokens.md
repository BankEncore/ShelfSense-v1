...
- **Status:** Proposed
- **Date:** 2026-08-22
- **Related:** [Phase 2.2 UX foundation](../planning/phase2.2-ux-foundation/phase-2.2-ux-foundation.md), [UX conventions](../ux-conventions.md), [UX design system](../planning/ux-design-system/README.md), [Warm Parchment](../planning/ux-design-system/warm-parchment.md), [Button and action semantics](../planning/ux-design-system/button-action-semantics.md)
...
When the UX design-system foundation (UDS-1) is accepted for implementation:
...
Until this ADR is **Accepted** and UDS-1 ships, [ux-conventions.md](../ux-conventions.md) Phase 2.2 tokens remain the implemented palette.

## Consequences

- New screens and migrated screens use Warm Parchment tokens after acceptance.
- Documentation indexes and conventions update when status moves from Proposed to Accepted/Implemented.
