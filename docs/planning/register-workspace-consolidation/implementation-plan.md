...
Status: **Slice 4 in review** ([PR #98](https://github.com/BankEncore/ShelfSense-v1/pull/98) → `register-workspace-consolidation`). Slice 3 is on the integration branch.
...
| 4 Transaction composition | In review ([PR #98](https://github.com/BankEncore/ShelfSense-v1/pull/98); [slice4-composition-plan.md](slice4-composition-plan.md)) | [#85](https://github.com/BankEncore/ShelfSense-v1/issues/85) |
