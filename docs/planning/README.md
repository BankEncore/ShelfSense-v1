...
| [Product variant attributes](product-variant-attributes/README.md) | **Accepted.** Existing option labels/values, derived names, inheritance UX, receipt snapshots, active-by-default create. Not a numbered domain phase |
