...
**Status:** **Proposed** — UDS-5.0 packet and compact-nav prototype gate **Passed**; UDS-5.1–5.4A complete on `uds-5-administrative-composition` ([uds-5-plan.md](ux-design-system/uds-5-plan.md)).
