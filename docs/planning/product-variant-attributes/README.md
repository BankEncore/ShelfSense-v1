...
**Status:** **Proposed.** Do not implement until this packet is **Accepted**.
...
This is a focused merchandise correction in the spirit of Phase 6.1. It does not introduce a second product model, change the Product → Product Variant → Used inventory unit relationship, or generate an attribute matrix.
