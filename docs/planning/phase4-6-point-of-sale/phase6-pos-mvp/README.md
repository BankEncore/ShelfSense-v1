...
**Status:** Slice 6.0 contract locked. Slices 6.1–6.6 are implemented. Slice 6.7 operator workflow contract is locked ([pos-workflow.md](pos-workflow.md)). Slice 6.8 closeout contract is locked ([mvp-closeout.md](mvp-closeout.md)).
...
| [pos-workflow.md](pos-workflow.md) | Slice 6.7: cashier Home, keys, pickers, open-price Standard, return entry, X Report (locked) |
| [mvp-closeout.md](mvp-closeout.md) | Slice 6.8: presentation, regression; no new commercial behavior (locked) |
| [receipt-presentation.md](receipt-presentation.md) | Customer print/reprint layout (locked; implement in 6.8) |
...
Where this packet and `../spec.md` disagree on Phase 6 slice order, open ring, suspend/recall, cash operations, Store Close, or MVP deferrals, **prefer this packet**. 6.2–6.8 contracts are written. Build 6.7 next, then 6.8.
