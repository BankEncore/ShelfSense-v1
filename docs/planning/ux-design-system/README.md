...
| [uds-5-plan.md](uds-5-plan.md) | UDS-5 administrative composition (grammar, compact nav presentation, Product reference family) | **Proposed** (5.0–5.2 complete; 5.0 gate Passed) |
...
| [shelvesense-warm-parchment-product-mockups.html](shelvesense-warm-parchment-product-mockups.html) | Product admin chrome | Inspirational overall; composition regions **Proposed** for UDS-5; sidebar/Cmd+K **deferred** (UDS-7) |
...
Implementing CSS, migrating all screens, global search, master-detail drawers, or changing Register keyboard bindings. See [program-plan.md](program-plan.md) and [deferred-patterns.md](deferred-patterns.md). UDS-5 composition work is specified in [uds-5-plan.md](uds-5-plan.md) and does not pull UDS-7 sidebar/search into scope.
