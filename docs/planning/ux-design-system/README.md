...
| [uds-5-plan.md](uds-5-plan.md) | UDS-5 administrative composition (grammar, compact nav presentation, Product reference family) | **Proposed** (5.0–5.4B complete; 5.0 gate Passed) |
