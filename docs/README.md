...
| [Phase 6.1 classification and identifiers](planning/phase6.1-merchandise-classification-and-identifiers/README.md) | Proposed merchandise classification cutover, lookup codes, and POS/inventory targeting (disposable data; no backward compatibility) |
