...
| [Product variant attributes](planning/product-variant-attributes/README.md) | **Proposed.** Operable attribute labels/values, derived names, inheritance UX, receipt snapshots, active-by-default create |
