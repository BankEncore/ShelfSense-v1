...
ActiveRecord::Schema[8.1].define(version: 2026_08_24_090000) do
  ...
  create_table "contributors", id: :uuid, default: nil, force: :cascade do |t|
    ...
    t.timestamptz "updated_at", null: false
    t.index ["name_normalized"], name: "index_contributors_on_name_normalized", unique: true
  end
  ...
  create_table "product_contributions", id: :uuid, default: nil, force: :cascade do |t|
    ...
    t.timestamptz "updated_at", null: false
    t.index ["contributor_id"], name: "index_product_contributions_on_contributor_id"
    t.index ["product_id", "contributor_id", "role"], name: "index_product_contributions_uniqueness", unique: true
    t.check_constraint "role::text = ANY (ARRAY['author'::character varying, 'illustrator'::character varying, 'editor'::character varying, 'translator'::character varying, 'other'::character varying]::text[])", name: "product_contributions_role_valid"
  end
  ...
  create_table "products", id: :uuid, default: nil, force: :cascade do |t|
    ...
    t.string "bibliographic_curated_fields", default: [], null: false, array: true
    ...
    t.check_constraint "publication_year IS NULL OR publication_year >= 1400 AND publication_year <= 2100", name: "products_publication_year_range"
  ...
  create_table "publishers", id: :uuid, default: nil, force: :cascade do |t|
    t.timestamptz "created_at", null: false
    t.integer "lock_version", default: 0, null: false
    t.string "name", null: false
    t.string "name_normalized", null: false
    t.timestamptz "updated_at", null: false
    t.index ["name_normalized"], name: "index_publishers_on_name_normalized", unique: true
  end
