...
class AddPhase66PostVoid < ActiveRecord::Migration[8.1]
  def up
    add_reference :pos_transactions, :post_void_of_transaction, type: :uuid,
    ...
    add_reference :pos_transaction_lines, :post_void_source_line, type: :uuid,
    ...
    add_reference :pos_tenders, :post_void_source_tender, type: :uuid,
  ...
  def down
    remove_check_constraint :pos_reporting_periods, name: "pos_reporting_periods_finalized_post_void_count_nonnegative"
    remove_column :pos_reporting_periods, :finalized_post_void_net_cents
    remove_column :pos_reporting_periods, :finalized_post_void_tax_cents
    remove_column :pos_reporting_periods, :finalized_post_void_discount_cents
    remove_column :pos_reporting_periods, :finalized_post_void_merchandise_cents
    remove_column :pos_reporting_periods, :finalized_post_void_transaction_count

    remove_index :pos_controlled_actions, name: "index_pos_controlled_actions_one_post_void"
    ...
    remove_check_constraint :pos_tenders, name: "pos_tenders_post_void_source_not_self"
    remove_reference :pos_tenders, :post_void_source_tender, foreign_key: { to_table: :pos_tenders }
    ...
    add_check_constraint :pos_transaction_lines,
                         ...
                         SQL
                         name: "pos_transaction_lines_return_reason_rules"
    remove_check_constraint :pos_transaction_lines, name: "pos_transaction_lines_lineage_exclusive"
    remove_check_constraint :pos_transaction_lines, name: "pos_transaction_lines_post_void_source_not_self"
    remove_reference :pos_transaction_lines, :post_void_source_line, foreign_key: { to_table: :pos_transaction_lines }

    remove_check_constraint :pos_transactions, name: "pos_transactions_post_void_not_self"
    remove_reference :pos_transactions, :post_void_of_transaction, foreign_key: { to_table: :pos_transactions }
  end
end
