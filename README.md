...
Authoritative plan: [phase-2.2-ux-foundation.md](docs/planning/phase2.2-ux-foundation/phase-2.2-ux-foundation.md). Conventions: [UX conventions](docs/ux-conventions.md). Proposed cross-phase evolution: [UX design system](docs/planning/ux-design-system/README.md) (Warm Parchment; not a Phase 7 slice), including the [permission-aware administrative navigation proposal](docs/planning/ux-design-system/navigation-proposal.md), which requires privileged and narrowly scoped prototypes before UDS adoption. **UDS-1 implementation plan** ([uds-1-plan.md](docs/planning/ux-design-system/uds-1-plan.md)) is ready to implement; it is not a Phase 7 slice and requires [ADR-022](docs/adr/ADR-022-warm-parchment-visual-tokens.md) Accepted before token merge.
...
- [UX design system](docs/planning/ux-design-system/README.md) (Proposed Warm Parchment / action semantics), [UDS-1 implementation plan](docs/planning/ux-design-system/uds-1-plan.md), and [ADR-022](docs/adr/ADR-022-warm-parchment-visual-tokens.md)
